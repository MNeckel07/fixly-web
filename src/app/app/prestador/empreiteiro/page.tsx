...
/**
 * "Sou empreiteiro" — o mesmo anúncio, agora acessível pelo lado do prestador.
 *
 * Antes essa tela só existia dentro da área do contratante, então o
 * profissional que também tem empresa não tinha como anunciar sem trocar de
 * conta. A área é do dono do anúncio (`owner_id`), não do papel.
 */
export default async function PrestadorEmpreiteiroPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <Link href="/app/prestador/perfil" className="inline-flex items-center gap-1 text-sm text-gray hover:text-ink mb-4">
      ...
      <p className="text-gray mb-5">
        Além dos seus serviços no Fixly, anuncie a sua empresa para quem procura mão de
        obra para obra inteira. Mensalidade, sem comissão por serviço.
      </p>
      <EmpreiteiroForm
        ownerId={userId}
