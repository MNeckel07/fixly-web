...
const ITEMS: NavItem[] = [
  { href: "/app/contratante", label: "Início", icon: "🏠" },
  { href: "/app/contratante/solicitar", label: "Solicitar", icon: "➕" },
  { href: "/app/contratante/historico", label: "Histórico", icon: "🕑" },
  { href: "/app/contratante/perfil", label: "Perfil", icon: "👤" },
];
