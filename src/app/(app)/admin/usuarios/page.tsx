...
export default async function UsuariosPage() {
  ...
  const { data } = await supabase
    .from("profiles")
    .select("id, full_name, role, status, city, active, fix_badge, funcao, permissions, created_at, category:service_categories!profiles_category_id_fkey(name), private:profiles_private(email, phone, username)")
